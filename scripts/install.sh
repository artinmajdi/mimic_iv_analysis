...
# Print header
echo -e "${BLUE}===========================================================${NC}"
echo -e "${BLUE}          MIMIC-IV Analysis Installation Script           ${NC}"
echo -e "${BLUE}===========================================================${NC}"
echo ""
...
setup_docker() {
    ...
    if docker build -t mimic-iv-analysis .; then
...
setup_conda() {
    ...
    # Set environment name for MIMIC-IV Analysis
    ENV_NAME="mimic_iv_env"
